...
export const profileCardMethods = {
  ...
  createProfileDetails(profile) {
    ...
    details.append(
      this.createProfileSummary(profile),
      this.createProfileCookieList(profile),
      this.createProfileDownloads()
    );
    return details;
  },
  ...
  createProfileSummary(profile) {
    ...
    summary.textContent = `Recent activity ${this.formatProfileDate(
      profile.updatedAt || profile.createdAt
    )}`;
    return summary;
  },

  createProfileCookieList(profile) {
