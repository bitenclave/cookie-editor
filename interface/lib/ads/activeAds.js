...
export const ActiveAds = Object.freeze([
  new Ad({
    id: 'cookie-editor',
    text: 'Cookie-Editor is maintained by the BitEnclave Team.',
    tooltip: 'View the BitEnclave Cookie-Editor source repository.',
    url: 'https://github.com/bitenclave/cookie-editor',
